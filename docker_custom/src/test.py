...
config = {
	'model_def' : '/opt/caffe/models/deploy.prototxt',
	'model_weights' : '/mnt/share/model_icdar15.caffemodel',	
	'det_visu_path' : '/mnt/share/demo_images/demo_det_result.jpg',
	'rec_visu_path' : '/mnt/share/demo_images/demo_rec_result.jpg',
	'det_save_dir' : '/mnt/share/demo_images/detection_result/',
	'rec_save_dir' : '/mnt/share/demo_images/recognition_result/',
	'crop_dir' : '/mnt/share/captions/crops/',
...
# args
parser = argparse.ArgumentParser(description='Caption detection with TextBoxes++')
parser.add_argument('--image', default='demo.png', type=str, help='Demo image to process')
parser.add_argument('--img_dir', default='/mnt/share/captions/', type=str, help='Demo image directory')
parser.add_argument('--recognition', default=False, type=bool, help='Apply recognition to the image')
args = parser.parse_args()
config['image_name'] = args.image
config['img_dir'] = args.img_dir
config['apply_recognition'] = args.recognition
print("config", config)
